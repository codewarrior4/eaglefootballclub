                        ...
                        <div class="uk-width-1-1">
                            <div class="uk-panel">
                                <div class="footer-logo">
                                    <a href="index.php"><img src="images/logo-img.png" alt=""><span>EAGLE ATHLETIC </span> FC</a>
                                </div>
                                ...
                                <div class="footer-wrap">
                                    <div class="foot-menu-wrap">
                                        <ul class="nav menu">
                                            ...
                                            <li class="item-167"><a href="gallery.php">Gallery</a>
                                            </li>
                                            <li class="item-168"><a href="contact.php">Contact</a>
                                            </li>
                                            <li class="item-169"><a href="news.php">News</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="copyrights">Copyright &copy; <script>var date= new Date(); document.write(date.getFullYear())</script> <a href="index.php">Eagle Athletic Footbal Club</a>. All Rights Reserved.</div>
                                    <div class="clear"></div>
                                </div>
                            </div>
                        </div>
