...
<head>
    ...
    <title>Eagle Athletic Football Club</title>
    <link href="http://fonts.googleapis.com/css?family=Roboto:300,400,500,700" rel="stylesheet" type="text/css">
    <link href="images/logo-img.png" rel="shortcut icon" type="image/vnd.microsoft.icon">
                                    ...
                                    <div class="uk-grid">
                                        <div class="uk-width-medium-1-1">
                                            <div class="last-video-title">
                                                <h1 style="font-weight:bolder;color:#00afd8">OUR <span>SPONSORS</span></h1>
                                            </div>
                                        </div>
                                        <div class="uk-width-medium-8-10 uk-width-small-1-1 uk-push-1-10">
                        ...
                        <div class="uk-panel">
                            <div class="map-wrap">
                                        ...
                                        <div class="uk-grid  uk-grid-collapse uk-flex-item-1 uk-height-1-1 uk-nbfc">
                                            <div class="uk-width-5-10 contact-left uk-vertical-align contact-left-wrap">
                                                <div class="contact-info-lines uk-vertical-align-middle">
                                                    ...
                                                    <div class="item mail"><span class="icon"><i class="uk-icon-envelope"></i></span><a href="mailto:support@torbara.com">support@eafc.com</a>
                                                        
                                                    </div>
                                                    <div class="item location"><span class="icon"><i class="uk-icon-map-marker"></i></span>Iyanaoworo</div>
                                                </div>
                                            </div>
                                ...
                                <script>
                                    ...
                                    function initialize(){
                                        var myLatlng = new google.maps.LatLng(6.5550,3.3962);
